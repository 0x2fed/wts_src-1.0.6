...
interface
 ...
 function VerifyCHV(var Port:TBlockSerial;Num:byte;Pin:String[8]):Longint;
 function Gsm(var Port:TBlockSerial;Rand:TData16;var SRes:TData12):Longint;
 function ReadIMSI(var Port:TBlockSerial;var IMSI:String[18]):Longint;
...
implementation
 ...
 function ReadInitLog(var Port:TBlockSerial;Seconds:Longword):Longint; 
  var
   ...
   Res:Longint;
   B:byte;
   StartTime,CurTime,AllTime:ULong;
  begin
   Res:=0;
